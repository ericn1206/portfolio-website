...
// ROTATING "CURRENTLY:" STATUS
const currentlyEl = document.getElementById("currently-status");
if (currentlyEl) {
    const statuses = [
        "currently: caffeinating",
        "currently: doomscrolling linkedin",
        "currently: in cory hall",
        "currently: fighting a seagull",
        "currently: on my third iced americano",
        "currently: cooked",
...
slides.forEach(slide => {
    slide.addEventListener("mouseenter", () => { carousel1.classList.add("hovering"); });
    slide.addEventListener("mouseleave", () => { carousel1.classList.remove("hovering"); });
});
